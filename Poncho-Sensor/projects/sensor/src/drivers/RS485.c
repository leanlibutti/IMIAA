...
void rsConfig(uint8_t address){
	...
	Chip_UART_SetupFIFOS(LPC_USART0, UART_FCR_FIFO_EN |UART_FCR_RX_RS| UART_FCR_TX_RS | UART_FCR_TRG_LEV0); /* habilita la cola fifo y seteo para que la interrupcion en la recepcion se genere cada 2 bytes */
